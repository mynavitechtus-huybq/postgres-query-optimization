...
và không cần sắp xếp gì nữa.

Đây là cách nhanh nhất trong số các cách vẫn giữ được dữ liệu mới nhất. Mình bỏ nó chỉ
vì đề bài yêu cầu không dùng, chứ không phải vì nó dở.
